    ...
    <div className="flex min-h-screen flex-col">
      <main className="flex-1">
        ...
        <section className="mx-auto max-w-4xl px-4 pt-10 pb-6 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-3 py-1 text-sm text-gray-700 mx-auto w-fit">
            <span>✨</span>
          ...
          <p className="mt-2 max-w-2xl text-gray-600 mx-auto">
