...
-- This script ensures the bio column exists and is properly configured
...
BEGIN
    ...
    INSERT INTO user_profiles (id, display_name, bio, location, website, institution, position)
    VALUES (
        test_user_id,
        'Test User',
        test_bio,
