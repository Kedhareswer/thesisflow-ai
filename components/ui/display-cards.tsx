...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-32 w-[20rem] -skew-y-[8deg] select-none flex-col justify-center rounded-xl border-2 bg-muted/70 backdrop-blur-sm px-4 py-4 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[18rem] after:bg-gradient-to-l after:from-background after:to-transparent after:content-[''] hover:border-white/20 hover:bg-muted",
        className
      )}
    >
